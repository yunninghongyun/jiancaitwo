...
let url = window.api
class Jiexiangsix extends Component {
  constructor(props) {
    super(props)
    this.state = {
      id: 0,
    ...
    return (
      <div>
        <div className="register_container">
          <div className="zhuceform six-title">
            <div className="form_title six-title">附：支撑材料目录</div>
            <div className="form_content socialServices jiexiangsix">
              <table>
                <tbody>
                  <tr className="top">
                    <td>
