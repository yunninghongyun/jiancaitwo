...
let url = window.api
class Jiexiangone extends Component {
  constructor(props) {
    super(props)
    this.state = {
      id: 0,
      ...
      <div>
        <div className="register_container">
          <div className="zhuceform">
            <div className="form_title">服务项目内容简介</div>
            <div className="form_content socialServices jiexiangone">
              <table>
                <tbody>
                  <tr className="top">
                    <td>服务项目名称</td>
